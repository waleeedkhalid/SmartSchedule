...
export const getServerUser = cache(async (): Promise<ServerUser | null> => {
  ...
  try {
    ...
    try {
      ...
      console.warn(
        "Unexpected error fetching user role in getServerUser:",
        error
      );
      return null;
    }
...
// ============================================================================
// Re-exports from DAL for gradual migration
// When USE_NEW_AUTH is enabled, prefer using these exports directly from lib/dal.ts
// ============================================================================
...
export type { DalUser } from "@/lib/dal";
