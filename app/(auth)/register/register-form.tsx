...
// Password input loaded on demand when user focuses on password field
...
// Progress bar only shown when password has content
const Progress = dynamic(
  () => import("@/components/ui/progress").then((mod) => mod.Progress),
  { ssr: false }
);

// Alert is static content, can be lazily loaded
const Alert = dynamic(
        ...
        if (response.error) {
          ...
          if (
            ...
            toast.error(response.error, {
              duration: 8000,
              description:
                "This appears to be a system configuration issue. Please contact your administrator.",
            });
          }
          // Duplicate email
          else if (
              ...
              <FormItem>
                ...
                <FormDescription className="text-xs space-y-1">
                  ...
                  <ul className="list-disc list-inside space-y-0.5 text-muted-foreground">
                    ...
                    <li
                      className={
                        isMounted && /\d/.test(password) ? "text-green-600" : ""
                      }
                    >
                      One number
                    </li>
