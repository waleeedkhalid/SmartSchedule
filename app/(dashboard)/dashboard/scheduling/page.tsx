...
import { GenerateFinalExamsButton } from "@/components/generate-final-exams-button";
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {stats.draftSectionsCount} draft,{" "}
                    {stats.releasedSectionsCount} released
                  </p>
                </CardContent>
              </Card>
            ...
            {isSystemReady ? (
              ...
              <Card className="mb-6 border-yellow-200 dark:border-yellow-800">
                ...
                <CardContent className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  generating schedules. Use the quick actions tab to get
                  started.
                </CardContent>
              </Card>
            )}
