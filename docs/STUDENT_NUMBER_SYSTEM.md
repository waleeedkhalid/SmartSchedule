...
Every student receives a unique 10-digit student number after completing onboarding. The student number is automatically generated based on:
...
**Format:** `{last_3_digits_of_hijri_year}{sequence}` = 10 digits total

- **Year Prefix:** 3 digits (000-999) - Last 3 digits of the Hijri enrollment year
- **Sequence:** 7 digits (0000001-9999999) - Unique sequence number
- **Note:** Level is NOT included in the student number format

**Examples:**
- Student enrolled in 1447H → Last 3 digits = 447 → Student number: `4470000001`
- Student enrolled in 1550H → Last 3 digits = 550 → Student number: `5500000001`
- Student enrolled in 1445H → Last 3 digits = 445 → Student number: `4450000001`
...
Generates a unique 10-digit student number.
...
**Returns:** 10-digit student number string
...
5. Formats: `{last_3_digits_of_hijri_year}{7-digit-sequence}`
...
2. **Format:** Exactly 10 digits, numeric only
3. **Validation:** Database constraint ensures format: `^[0-9]{10}$`
4. **Sequence:** Sequence numbers increment per year+level combination
...
- **Last 3 digits:** 447
- **Student Number:** `4470000001`

### Example 2: Student Enrolled in Different Year
- **Enrollment Year:** 1550H
- **Last 3 digits:** 550
- **Student Number:** `5500000001`

### Example 3: Multiple Students Same Year
- **Student 1:** Year 1447H (447) → `4470000001`
- **Student 2:** Year 1447H (447) → `4470000002`
- **Student 3:** Year 1447H (447) → `4470000003`

### Example 4: Different Years
- **Student 1:** Year 1445H (445) → `4450000001`
- **Student 2:** Year 1447H (447) → `4470000001`
- **Student 3:** Year 1550H (550) → `5500000001`
...
**Examples:**
- Enrollment year: 1447H → Last 3 digits = 447 → Student number: `4470000001`
- Enrollment year: 1550H → Last 3 digits = 550 → Student number: `5500000001`
- Enrollment year: 1445H → Last 3 digits = 445 → Student number: `4450000001`
- Enrollment year: 1500H → Last 3 digits = 500 → Student number: `5000000001`
...
4. **`fix_student_number_format_10_digits`** - Ensure exactly 10 digits
5. **`fix_student_number_format_year_first`** - Format: year first, then level
...
-- Should return: 4540000001 (10 digits)
```
...
- Year prefix calculation accounts for the student's level to reflect actual enrollment year
