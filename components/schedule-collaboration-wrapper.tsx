    ...
    useEffect(() => {
        ...
        async function initializeYjs() {
            try {
                ...
                const provider = new IndexeddbPersistence('schedule-dashboard-collab', ydoc);
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <Badge
                                    ...
                                    className={`text-xs px-3 py-1 transition-all ${isConnected ? 'animate-pulse' : ''}`}
                                >
                                    ...
                                    {saveStatus === 'saved' && lastSavedTime && (
                                        ...
                                        >
                                            ...
                                            <span className="text-sm">
                                                Saved at {lastSavedTime.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })}
                                            </span>
                                        </motion.div>
                                    )}
                                    {saveStatus === 'saving' && (
