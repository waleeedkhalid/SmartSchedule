...
export function Logo({ variant = "full", size = "md", className }: LogoProps) {
  ...
  const IconMark = () => (
    ...
    >
      ...
      <rect x="17" y="8" width="6" height="6" rx="1.5" fill="white" opacity="0.6" />
      <rect x="26" y="8" width="6" height="6" rx="1.5" fill="white" opacity="0.4" />
      
      {/* Middle row */}
      <rect x="8" y="17" width="6" height="6" rx="1.5" fill="white" opacity="0.6" />
      <rect x="17" y="17" width="6" height="6" rx="1.5" fill="white" opacity="0.9" />
      <rect x="26" y="17" width="6" height="6" rx="1.5" fill="white" opacity="0.6" />
      
      {/* Bottom row - merged cells showing schedule flexibility */}
      <rect x="8" y="26" width="15" height="6" rx="1.5" fill="white" opacity="0.4" />
      <rect x="26" y="26" width="6" height="6" rx="1.5" fill="white" opacity="0.9" />
    </svg>
  );

  const Wordmark = () => (
    <span className={cn("font-bold tracking-tight", sizes.text)}>
      Smart<span className="text-brand-blue dark:text-brand-blue-500">Schedule</span>
    </span>
  );
