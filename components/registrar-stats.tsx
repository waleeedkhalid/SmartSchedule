...
/**
 * Fetch registrar stats from multiple APIs in parallel
 * Using React Query for automatic caching, deduplication, and background updates
 */
async function fetchRegistrarStats(): Promise<RegistrarStatsData> {
