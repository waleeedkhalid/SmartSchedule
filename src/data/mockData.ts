...
export const mockElectivePackages = [
  {
    ...
    maxHours: 4,
    courses: [
      { code: "QRAN100", name: "Holy Quran", credits: 2 },
      { code: "IC100", name: "Studies in the Prophet's Biography", credits: 2 },
      { code: "IC101", name: "Fundamentals of Islamic Culture", credits: 2 },
      { code: "IC102", name: "The Family in Islam", credits: 2 },
      { code: "IC103", name: "The Islamic Economic System", credits: 2 },
      { code: "IC104", name: "The Islamic Political System", credits: 2 },
      { code: "IC105", name: "Women and Their Developmental Role", credits: 2 },
      { code: "IC106", name: "Medical Jurisprudence (Fiqh)", credits: 2 },
      { code: "IC109", name: "Human Rights", credits: 2 },
    ],
  },
  {
    id: "mathStats",
    ...
    maxHours: 6,
    courses: [
      { code: "MATH203", name: "Numerical Methods", credits: 3 },
      { code: "MATH254", name: "Calculus Guarantee", credits: 3 },
      {
        code: "OPER122",
  ...
  },
  {
    ...
    maxHours: 3,
    courses: [
      { code: "BIO145", name: "Biology", credits: 3 },
      { code: "BIO140", name: "Microbiology", credits: 3 },
      { code: "CHEM101", name: "General Biochemistry", credits: 3 },
    ],
  },
  {
    ...
    courses: [
      ...
      { code: "CSC311", name: "Design and Analysis of Algorithms", credits: 3 },
      {
        code: "CEN316",
        name: "Computer Architecture and Assembly Languages",
        credits: 3,
      },
      { code: "CEN318", name: "Embedded Systems", credits: 4 },
      { code: "CSC361", name: "Artificial Intelligence", credits: 3 },
      {
        code: "IS385",
        name: "Enterprise Resource Planning Systems",
        credits: 3,
      },
      { code: "SWE484", name: "Multimedia Computing", credits: 3 },
      { code: "SWE483", name: "Selected Topics (Specific Area)", credits: 3 },
      { code: "CEN445", name: "Network Protocols and Algorithms", credits: 3 },
      { code: "CSC476", name: "Computer Graphics", credits: 3 },
      { code: "CSC478", name: "Web Application Engineering", credits: 3 },
      { code: "SWE485", name: "Mobile Application Development", credits: 3 },
      { code: "IS485", name: "Cloud Computing and Big Data", credits: 3 },
      { code: "SWE486", name: "Complex Systems Engineering", credits: 3 },
      {
        code: "SWE488",
...
export const mockARElectivePackages = [
  {
    id: "universityRequirements",
    label: "University Requirements (متطلبات الجامعة)",
    rangeLabel: "4 hours (4-0)",
    minHours: 4,
    maxHours: 4,
    courses: [
      { code: "100 قرأ", name: "القرآن الكريم", credits: 2 },
      { code: "100 سلم", name: "دراسات في السيرة النبوية", credits: 2 },
      { code: "101 سلم", name: "أصول الثقافة الإسلامية", credits: 2 },
      { code: "102 سلم", name: "الأسرة في الإسلام", credits: 2 },
      { code: "103 سلم", name: "النظام الاقتصادي الإسلامي", credits: 2 },
      { code: "104 سلم", name: "النظام السياسي الإسلامي", credits: 2 },
      { code: "105 سلم", name: "المرأة ودورها التنموي", credits: 2 },
      { code: "106 سلم", name: "الفقه الطبي", credits: 2 },
      { code: "109 سلم", name: "حقوق الإنسان", credits: 2 },
    ],
  },
  {
    id: "mathStats",
    label: "Math and Statistics Requirements (متطلبات رياضية واحصائية)",
    rangeLabel: "6 hours (6-0)",
    minHours: 6,
    maxHours: 6,
    courses: [
      { code: "203 ريض", name: "الطرائق المدنية", credits: 3 },
      { code: "254 ريض", name: "ضمان التفاضل والتكامل", credits: 3 },
      { code: "122 بحث", name: "مقدمة في بحوث العمليات.", credits: 3 },
    ],
  },
  {
    id: "generalScience",
    label: "General Science Requirements (متطلبات علمية عامة في العلوم)",
    rangeLabel: "3 hours (3-0)",
    minHours: 3,
    maxHours: 3,
    courses: [
      { code: "145 حين", name: "علم الأحياء", credits: 3 },
      { code: "140 حدق", name: "علم الأحياء الدقيقة", credits: 3 },
      { code: "101 كيح", name: "كيمياء حيوية عامة", credits: 3 },
    ],
  },
  {
    id: "departmentElectives",
    label: "Department Electives (متطلبات القسم)",
    rangeLabel: "9 hours (9-0)",
    minHours: 9,
    maxHours: 9,
    courses: [
      { code: "215 عال", name: "البرمجة الإجرائية بلغة .", credits: 3 },
      { code: "311 عال", name: "تصميم وتحليل الخوارزميات", credits: 3 },
      { code: "316 هال", name: "عمارة الحاسبات ولغات التجميع", credits: 3 },
      { code: "318 هال", name: "النظم المضمنة", credits: 4 },
      { code: "361 عال", name: "الذكاء الاصطناعي", credits: 3 },
      { code: "385 نال", name: "عظم تخطيط موارد المؤسسات", credits: 3 },
      { code: "484 هاب", name: "حوسبة الوسائط المتعددة", credits: 3 },
      { code: "483 هاب", name: "المنطوية", credits: 3 },
      { code: "445 هال", name: "بروتوكولات و خوارزميات الشبكات", credits: 3 },
      { code: "476 عال", name: "الرسومات باستخدام الحاسب", credits: 3 },
      { code: "478 عال", name: "هندسة تطبيقات الشبكة العنكبوتية", credits: 3 },
      { code: "485 هاب", name: "تطوير تطبيقات الجوال", credits: 3 },
      {
        code: "485 نال",
        name: "الحوسبة السحابية والبيانات الضخمة",
        credits: 3,
      },
      { code: "486 هاب", name: "هندسة النظم المعقدة", credits: 3 },
      {
        code: "488 هاب",
        name: "موضوعات مختارة في هندسة البرمجيات",
        credits: 3,
      },
    ],
  },
