...
type CourseTime = { day: string; start: string; end: string };
type CourseSection = {
  id: string;
  courseCode: string;
  instructor: string;
...
type DepartmentsData = { courses: Course[] };

const Data = data as unknown as DepartmentsData;
...
export type ConstraintFormProps = {
  onSubmit?: (data: Constraint) => Promise<void> | void;
  title?: string;
  subtitle?: string;
};
...
export function CoursesEditor({
  ...
  subtitle = "Capture constraints that affect scheduling",
}: ConstraintFormProps): React.ReactElement {
  ...
  const departments = useMemo(() => {
    ...
    Data.courses.forEach((c) => set.add(c.department));
    return Array.from(set).sort();
  }, []);

  const departmentCourses = useMemo((): Array<{
    code: string;
    name: string;
    level: number;
    type: string;
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Constraint recorded for {department}.
          </p>
        </CardContent>
      </Card>
    );
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              >
                <SelectTrigger>
                  <SelectValue
                    placeholder={
                      department ? "Select course" : "Select a department first"
                    }
                  />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Avoid scheduling MATH labs on Mondays 12-2 PM"
                rows={4}
              />
            </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div>
                        ...
                        <Input
                          type="date"
                          value={editableExams?.midterm?.date || ""}
                          onChange={(e) =>
                            setEditableExams((prev) => ({
                              ...(prev || {}),
                              midterm: {
                                date: e.target.value,
                                time: prev?.midterm?.time || "",
                                duration: prev?.midterm?.duration || 90,
                              },
                            }))
                          }
                        />
                      ...
                      <div>
                        ...
                        <Input
                          type="time"
                          value={editableExams?.midterm?.time || ""}
                          onChange={(e) =>
                            setEditableExams((prev) => ({
                              ...(prev || {}),
                              midterm: {
                                date: prev?.midterm?.date || "",
                                time: e.target.value,
                                duration: prev?.midterm?.duration || 90,
                              },
                            }))
                      ...
                      <div>
                        <Label className="text-xs">
                          Midterm Duration (min)
                        </Label>
                        <Input
                          type="number"
                          value={editableExams?.midterm?.duration ?? 90}
                          onChange={(e) =>
                            setEditableExams((prev) => ({
                              ...(prev || {}),
                              midterm: {
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div>
                        ...
                        <Input
                          type="date"
                          value={editableExams?.midterm2?.date || ""}
                          onChange={(e) =>
                            setEditableExams((prev) => ({
                              ...(prev || {}),
                              midterm2: {
                                date: e.target.value,
                                time: prev?.midterm2?.time || "",
                                duration: prev?.midterm2?.duration || 90,
                              },
                            }))
                          }
                        />
                      ...
                      <div>
                        ...
                        <Input
                          type="time"
                          value={editableExams?.midterm2?.time || ""}
                          onChange={(e) =>
                            setEditableExams((prev) => ({
                              ...(prev || {}),
                              midterm2: {
                                date: prev?.midterm2?.date || "",
                                time: e.target.value,
                                duration: prev?.midterm2?.duration || 90,
                              },
                            }))
                      ...
                      <div>
                        <Label className="text-xs">
                          2nd Midterm Duration (min)
                        </Label>
                        <Input
                          type="number"
                          value={editableExams?.midterm2?.duration ?? 90}
                          onChange={(e) =>
                            setEditableExams((prev) => ({
                              ...(prev || {}),
                              midterm2: {
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div>
                        ...
                        <Input
                          type="date"
                          value={editableExams?.final?.date || ""}
                          onChange={(e) =>
                            setEditableExams((prev) => ({
                              ...(prev || {}),
                              final: {
                                date: e.target.value,
                                time: prev?.final?.time || "",
                                duration: prev?.final?.duration || 120,
                              },
                            }))
                          }
                        />
                      ...
                      <div>
                        ...
                        <Input
                          type="time"
                          value={editableExams?.final?.time || ""}
                          onChange={(e) =>
                            setEditableExams((prev) => ({
                              ...(prev || {}),
                              final: {
                                date: prev?.final?.date || "",
                                time: e.target.value,
                                duration: prev?.final?.duration || 120,
                              },
                            }))
                      ...
                      <div>
                        ...
                        <Input
                          type="number"
                          value={editableExams?.final?.duration ?? 120}
                          onChange={(e) =>
                            setEditableExams((prev) => ({
                              ...(prev || {}),
                              final: {
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">
              {department} — Courses Preview ({departmentCourses.length})
            </CardTitle>
          </CardHeader>
          <CardContent>
