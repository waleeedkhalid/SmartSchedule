"use client";
// Student Registration ScheduleGrid (adapted to existing types in src/lib/types.ts)
// This file reuses the provided ScheduleGrid code with minimal path adjustments
// Types: Using Schedule & NormalizedTimeSlot from src/lib/types.ts

import React, { useMemo, useCallback } from "react";
import type { Schedule, NormalizedTimeSlot } from "@/lib/types";
...
import { getDayName, minutesToTimeString } from "./timeParser";
  ...
  const highlightClass = useCallback(
    (code: string): string | undefined => {
      ...
      const map: Record<HighlightType, string> = {
        ...
        remove: "ring-4 ring-red-400 opacity-70",
        swapA: "ring-4 ring-amber-400",
                ...
                {timeSlots.map((timeSlot, index) => (
                  <div
                    ...
                    className={cn(
                      ...
                      timeSlot.isHour
                        ? "font-bold bg-gray-50 dark:bg-slate-800 text-slate-900 dark:text-slate-100"
                    ...
                    return (
                      ...
                      >
                        <HoverCardTrigger asChild>
                          <div
                            onClick={() =>
                              onCourseClick?.(courseBlock.courseCode)
                            }
                            className={cn(
