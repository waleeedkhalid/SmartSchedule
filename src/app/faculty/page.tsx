  ...
  useEffect(() => {
    const fetchFacultyData = async () => {
      try {
        ...
        // Get faculty data from the database
        ...
        setFacultyData({
          ...
          role: userData.role,
          availabilitySubmitted: !!availabilityData,
          currentLoad: 0, // TODO: Calculate from actual assignments
          maxLoad: 20, // TODO: Get from faculty preferences
        });
      } catch (error) {
        console.error('Error fetching faculty data:', error);
      } finally {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <Button asChild className="w-full" size="lg">
                <Link href="/faculty/availability">
                  {facultyData.availabilitySubmitted ? "Update Availability" : "Submit Availability"}
        ...
        <Card className="hover:shadow-lg transition-all">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="text-sm text-muted-foreground">
                <p className="mb-2">Current load: {facultyData.currentLoad}/{facultyData.maxLoad} hours</p>
                <p className="text-xs">
            ...
            <div className="space-y-4">
              <div className="text-sm text-muted-foreground">
                ...
                <div className="space-y-1">
                  ...
                  <p><span className="font-medium">Role:</span> {facultyData.role.replace('_', ' ')}</p>
                </div>
              </div>
              <Button asChild className="w-full" variant="outline" size="lg">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  Please submit your time availability and teaching preferences to help the scheduling committee 
                  create an optimal schedule for all faculty members.
                </p>
                <Button asChild className="mt-3" size="sm">
                  <Link href="/faculty/availability">Submit Availability Now</Link>
                </Button>
              </div>
            </div>
          </CardContent>
