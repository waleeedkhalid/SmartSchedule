...
export default function SchedulerDashboardPage() {
    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-4">Scheduling Committee Dashboard</h1>
          <p className="text-muted-foreground">Unable to load scheduler data.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Scheduling Committee Dashboard</h1>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  No schedule has been generated yet. Use the schedule generation tools to create 
                  an optimal schedule based on current course offerings and student preferences.
                </p>
                <Button asChild className="mt-3" size="sm">
                  <Link href="/committee/scheduler/generate">Generate Schedule Now</Link>
                </Button>
              </div>
            </div>
          </CardContent>
