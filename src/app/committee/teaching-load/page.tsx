...
export default function TeachingLoadDashboardPage() {
    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-4">Teaching Load Committee Dashboard</h1>
          <p className="text-muted-foreground">Unable to load teaching load data.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Teaching Load Committee Dashboard</h1>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-800 dark:text-red-200">
                  {teachingLoadData.conflictsDetected} teaching load conflicts have been detected. 
                  Please review and resolve these conflicts to ensure optimal faculty workload distribution.
                </p>
                <Button asChild className="mt-3" size="sm">
                  <Link href="/committee/teaching-load/conflicts">Resolve Conflicts Now</Link>
                </Button>
              </div>
            </div>
          </CardContent>
