    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Unable to load registrar data.</p>
        </div>
      </div>
    );
  }
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  {registrarData.pendingOverrides} override requests are pending review. 
                  Please review and process these requests to help students with their course registration.
                </p>
                <Button asChild className="mt-3" size="sm">
                  <Link href="/committee/registrar/overrides">Review Overrides Now</Link>
                </Button>
              </div>
            </div>
          </CardContent>
